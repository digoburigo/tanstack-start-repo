...
type SchemaType = z.ZodType<Prisma.HealthPlansUncheckedCreateWithoutPatientInput>;
export const HealthPlansUncheckedCreateWithoutPatientInputObjectSchema: SchemaType = z.object({
    ...
    z.null()]).optional().nullable(), healthPlansValuesId: z.string()
