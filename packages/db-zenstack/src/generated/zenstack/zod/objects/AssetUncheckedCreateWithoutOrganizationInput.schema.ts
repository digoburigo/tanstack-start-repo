...
type SchemaType = z.ZodType<Prisma.AssetUncheckedCreateWithoutOrganizationInput>;
export const AssetUncheckedCreateWithoutOrganizationInputObjectSchema: SchemaType = z.object({
    ...
    z.null()]).optional().nullable(), deleted: z.boolean().optional().optional()
