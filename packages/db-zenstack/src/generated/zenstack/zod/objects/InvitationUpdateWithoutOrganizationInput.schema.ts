...
type SchemaType = z.ZodType<Prisma.InvitationUpdateWithoutOrganizationInput>;
export const InvitationUpdateWithoutOrganizationInputObjectSchema: SchemaType = z.object({
    id: z.union([z.string(),
    ...
    z.null()]).optional().nullable(), user: z.lazy(() => UserUpdateOneRequiredWithoutInvitationsNestedInputObjectSchema).optional().optional()
