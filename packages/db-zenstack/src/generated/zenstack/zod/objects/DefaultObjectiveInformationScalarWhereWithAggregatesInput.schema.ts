...
type SchemaType = z.ZodType<Prisma.DefaultObjectiveInformationScalarWhereWithAggregatesInput>;
export const DefaultObjectiveInformationScalarWhereWithAggregatesInputObjectSchema: SchemaType = z.object({
    AND: z.union([z.lazy(() => DefaultObjectiveInformationScalarWhereWithAggregatesInputObjectSchema),
    z.lazy(() => DefaultObjectiveInformationScalarWhereWithAggregatesInputObjectSchema).array()]).optional(), OR: z.lazy(() => DefaultObjectiveInformationScalarWhereWithAggregatesInputObjectSchema).array().optional().optional(), NOT: z.union([z.lazy(() => DefaultObjectiveInformationScalarWhereWithAggregatesInputObjectSchema),
    z.lazy(() => DefaultObjectiveInformationScalarWhereWithAggregatesInputObjectSchema).array()]).optional(), id: z.union([z.lazy(() => StringWithAggregatesFilterObjectSchema),
    ...
    z.string(),
    z.null()]).optional().nullable(), text: z.union([z.lazy(() => StringNullableWithAggregatesFilterObjectSchema),
    z.string(),
