...
type SchemaType = z.ZodType<Prisma.AppointmentCidUncheckedCreateWithoutOrganizationInput>;
export const AppointmentCidUncheckedCreateWithoutOrganizationInputObjectSchema: SchemaType = z.object({
    ...
    z.null()]).optional().nullable(), deleted: z.boolean().optional().optional(), appointmentId: z.string(), cidId: z.string()
