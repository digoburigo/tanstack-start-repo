...
type SchemaType = z.ZodType<Prisma.MedicationsCreateWithoutOrganizationInput>;
export const MedicationsCreateWithoutOrganizationInputObjectSchema: SchemaType = z.object({
    ...
    z.null()]).optional().nullable(), deleted: z.boolean().optional().optional(), createdByUser: z.lazy(() => UserCreateWithoutCreatedAssetsInputObjectSchema).optional().optional(), updatedByUser: z.lazy(() => UserCreateWithoutUpdatedAssetsInputObjectSchema).optional().optional(), deletedByUser: z.lazy(() => UserCreateWithoutDeletedAssetsInputObjectSchema).optional().optional(), patient: z.lazy(() => PatientCreateNestedOneWithoutMedicationsInputObjectSchema).optional().optional(), medicationsValues: z.lazy(() => MedicationsValuesCreateNestedOneWithoutMedicationsInputObjectSchema), appointment: z.lazy(() => AppointmentCreateNestedOneWithoutMedicationsInputObjectSchema).optional().optional()
