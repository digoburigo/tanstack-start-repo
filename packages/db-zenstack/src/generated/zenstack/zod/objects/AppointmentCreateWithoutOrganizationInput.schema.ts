...
import { EventCalendarCreateNestedOneWithoutAppointmentInputObjectSchema } from './EventCalendarCreateNestedOneWithoutAppointmentInput.schema';

import type { Prisma } from '../../models';

type SchemaType = z.ZodType<Prisma.AppointmentCreateWithoutOrganizationInput>;
export const AppointmentCreateWithoutOrganizationInputObjectSchema: SchemaType = z.object({
    ...
    z.null()]).optional().nullable(), createdByUser: z.lazy(() => UserCreateWithoutCreatedAssetsInputObjectSchema).optional().optional(), updatedByUser: z.lazy(() => UserCreateWithoutUpdatedAssetsInputObjectSchema).optional().optional(), deletedByUser: z.lazy(() => UserCreateWithoutDeletedAssetsInputObjectSchema).optional().optional(), followUp: z.lazy(() => AppointmentCreateNestedOneWithoutPredecessorFollowUpInputObjectSchema).optional().optional(), predecessorFollowUp: z.lazy(() => AppointmentCreateNestedOneWithoutFollowUpInputObjectSchema).optional().optional(), cids: z.lazy(() => AppointmentCidCreateNestedManyWithoutAppointmentInputObjectSchema).optional().optional(), allergies: z.lazy(() => AllergiesCreateNestedManyWithoutAppointmentInputObjectSchema).optional().optional(), medications: z.lazy(() => MedicationsCreateNestedManyWithoutAppointmentInputObjectSchema).optional().optional(), comorbidities: z.lazy(() => ComorbiditiesCreateNestedManyWithoutAppointmentInputObjectSchema).optional().optional(), patient: z.lazy(() => PatientCreateNestedOneWithoutAppointmentsInputObjectSchema), eventCalendar: z.lazy(() => EventCalendarCreateNestedOneWithoutAppointmentInputObjectSchema).optional().optional()
