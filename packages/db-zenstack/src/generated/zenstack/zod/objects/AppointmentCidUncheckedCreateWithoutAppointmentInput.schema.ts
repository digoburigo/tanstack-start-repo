...
type SchemaType = z.ZodType<Prisma.AppointmentCidUncheckedCreateWithoutAppointmentInput>;
export const AppointmentCidUncheckedCreateWithoutAppointmentInputObjectSchema: SchemaType = z.object({
    ...
    z.null()]).optional().nullable(), cidId: z.string()
