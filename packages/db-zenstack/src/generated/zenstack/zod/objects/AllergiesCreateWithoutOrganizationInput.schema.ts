...
type SchemaType = z.ZodType<Prisma.AllergiesCreateWithoutOrganizationInput>;
export const AllergiesCreateWithoutOrganizationInputObjectSchema: SchemaType = z.object({
    ...
    z.null()]).optional().nullable(), deleted: z.boolean().optional().optional(), createdByUser: z.lazy(() => UserCreateWithoutCreatedAssetsInputObjectSchema).optional().optional(), updatedByUser: z.lazy(() => UserCreateWithoutUpdatedAssetsInputObjectSchema).optional().optional(), deletedByUser: z.lazy(() => UserCreateWithoutDeletedAssetsInputObjectSchema).optional().optional(), patient: z.lazy(() => PatientCreateNestedOneWithoutAllergiesInputObjectSchema).optional().optional(), allergiesValues: z.lazy(() => AllergiesValuesCreateNestedOneWithoutAllergiesInputObjectSchema), appointment: z.lazy(() => AppointmentCreateNestedOneWithoutAllergiesInputObjectSchema).optional().optional()
