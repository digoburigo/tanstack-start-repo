...
import { ExamResultsValuesScalarRelationFilterObjectSchema } from './ExamResultsValuesScalarRelationFilter.schema';
import { ExamResultsValuesWhereInputObjectSchema } from './ExamResultsValuesWhereInput.schema';

import type { Prisma } from '../../models';

type SchemaType = z.ZodType<Prisma.ExamResultsWhereUniqueInput>;
export const ExamResultsWhereUniqueInputObjectSchema: SchemaType = z.object({
    id: z.string().optional().optional(), AND: z.union([z.lazy(() => ExamResultsWhereInputObjectSchema),
    z.lazy(() => ExamResultsWhereInputObjectSchema).array()]).optional(), OR: z.lazy(() => ExamResultsWhereInputObjectSchema).array().optional().optional(), NOT: z.union([z.lazy(() => ExamResultsWhereInputObjectSchema),
    z.lazy(() => ExamResultsWhereInputObjectSchema).array()]).optional(), type: z.union([z.lazy(() => StringFilterObjectSchema),
    ...
    z.string()]).optional(), examResultsValuesId: z.union([z.lazy(() => StringFilterObjectSchema),
    z.string()]).optional(), result: z.union([z.lazy(() => StringFilterObjectSchema),
    z.string()]).optional(), date: z.union([z.lazy(() => DateTimeFilterObjectSchema),
    z.union([z.date(), z.string().datetime().optional()])]).optional(), createdByUser: z.union([z.lazy(() => UserNullableScalarRelationFilterObjectSchema),
    ...
    z.lazy(() => PatientWhereInputObjectSchema)]).optional(), examResultsValues: z.union([z.lazy(() => ExamResultsValuesScalarRelationFilterObjectSchema),
    z.lazy(() => ExamResultsValuesWhereInputObjectSchema)]).optional()
