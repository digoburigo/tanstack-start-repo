...
import { AllergiesValuesScalarRelationFilterObjectSchema } from './AllergiesValuesScalarRelationFilter.schema';
...
type SchemaType = z.ZodType<Prisma.AllergiesWhereUniqueInput>;
export const AllergiesWhereUniqueInputObjectSchema: SchemaType = z.object({
    id: z.string().optional().optional(), AND: z.union([z.lazy(() => AllergiesWhereInputObjectSchema),
    z.lazy(() => AllergiesWhereInputObjectSchema).array()]).optional(), OR: z.lazy(() => AllergiesWhereInputObjectSchema).array().optional().optional(), NOT: z.union([z.lazy(() => AllergiesWhereInputObjectSchema),
    z.lazy(() => AllergiesWhereInputObjectSchema).array()]).optional(), type: z.union([z.lazy(() => StringFilterObjectSchema),
    ...
    z.null()]).optional().nullable(), allergiesValues: z.union([z.lazy(() => AllergiesValuesScalarRelationFilterObjectSchema),
    z.lazy(() => AllergiesValuesWhereInputObjectSchema)]).optional(), appointment: z.union([z.lazy(() => AppointmentNullableScalarRelationFilterObjectSchema),
