...
type SchemaType = z.ZodType<Prisma.PatientUncheckedCreateWithoutExamResultsInput>;
export const PatientUncheckedCreateWithoutExamResultsInputObjectSchema: SchemaType = z.object({
    ...
    z.null()]).optional().nullable(), appointments: z.lazy(() => AppointmentUncheckedCreateNestedManyWithoutPatientInputObjectSchema).optional().optional(), vaccinations: z.lazy(() => VaccinationsUncheckedCreateNestedManyWithoutPatientInputObjectSchema).optional().optional(), allergies: z.lazy(() => AllergiesUncheckedCreateNestedManyWithoutPatientInputObjectSchema).optional().optional(), medications: z.lazy(() => MedicationsUncheckedCreateNestedManyWithoutPatientInputObjectSchema).optional().optional(), comorbidities: z.lazy(() => ComorbiditiesUncheckedCreateNestedManyWithoutPatientInputObjectSchema).optional().optional(), surgeries: z.lazy(() => SurgeriesUncheckedCreateNestedManyWithoutPatientInputObjectSchema).optional().optional(), healthPlans: z.lazy(() => HealthPlansUncheckedCreateNestedManyWithoutPatientInputObjectSchema).optional().optional()
