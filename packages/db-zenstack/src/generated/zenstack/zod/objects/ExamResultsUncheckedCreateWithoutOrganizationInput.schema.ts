...
type SchemaType = z.ZodType<Prisma.ExamResultsUncheckedCreateWithoutOrganizationInput>;
export const ExamResultsUncheckedCreateWithoutOrganizationInputObjectSchema: SchemaType = z.object({
    ...
    z.null()]).optional().nullable(), deleted: z.boolean().optional().optional(), patientId: z.string(), examResultsValuesId: z.string(), result: z.string(), date: z.union([z.date(), z.string().datetime()])
