...
type SchemaType = z.ZodType<Prisma.AssetScalarWhereWithAggregatesInput>;
export const AssetScalarWhereWithAggregatesInputObjectSchema: SchemaType = z.object({
    AND: z.union([z.lazy(() => AssetScalarWhereWithAggregatesInputObjectSchema),
    z.lazy(() => AssetScalarWhereWithAggregatesInputObjectSchema).array()]).optional(), OR: z.lazy(() => AssetScalarWhereWithAggregatesInputObjectSchema).array().optional().optional(), NOT: z.union([z.lazy(() => AssetScalarWhereWithAggregatesInputObjectSchema),
    z.lazy(() => AssetScalarWhereWithAggregatesInputObjectSchema).array()]).optional(), id: z.union([z.lazy(() => StringWithAggregatesFilterObjectSchema),
