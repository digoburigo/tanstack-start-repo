...
type SchemaType = z.ZodType<Prisma.AppointmentUncheckedUpdateWithoutMedicationsInput>;
export const AppointmentUncheckedUpdateWithoutMedicationsInputObjectSchema: SchemaType = z.object({
    id: z.union([z.string(),
    ...
    z.lazy(() => StringFieldUpdateOperationsInputObjectSchema)]).optional(), predecessorFollowUp: z.lazy(() => AppointmentUncheckedUpdateOneWithoutFollowUpNestedInputObjectSchema).optional().optional(), cids: z.lazy(() => AppointmentCidUncheckedUpdateManyWithoutAppointmentNestedInputObjectSchema).optional().optional(), allergies: z.lazy(() => AllergiesUncheckedUpdateManyWithoutAppointmentNestedInputObjectSchema).optional().optional(), comorbidities: z.lazy(() => ComorbiditiesUncheckedUpdateManyWithoutAppointmentNestedInputObjectSchema).optional().optional(), eventCalendar: z.lazy(() => EventCalendarUncheckedUpdateOneWithoutAppointmentNestedInputObjectSchema).optional().optional()
