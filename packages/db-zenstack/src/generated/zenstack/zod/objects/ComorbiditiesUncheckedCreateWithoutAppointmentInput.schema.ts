...
type SchemaType = z.ZodType<Prisma.ComorbiditiesUncheckedCreateWithoutAppointmentInput>;
export const ComorbiditiesUncheckedCreateWithoutAppointmentInputObjectSchema: SchemaType = z.object({
    ...
    z.null()]).optional().nullable(), comorbiditiesValuesId: z.string()
