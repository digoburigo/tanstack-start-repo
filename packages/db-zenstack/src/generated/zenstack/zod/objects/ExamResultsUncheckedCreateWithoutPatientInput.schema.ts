...
type SchemaType = z.ZodType<Prisma.ExamResultsUncheckedCreateWithoutPatientInput>;
export const ExamResultsUncheckedCreateWithoutPatientInputObjectSchema: SchemaType = z.object({
    ...
    z.null()]).optional().nullable(), examResultsValuesId: z.string(), result: z.string(), date: z.union([z.date(), z.string().datetime()])
