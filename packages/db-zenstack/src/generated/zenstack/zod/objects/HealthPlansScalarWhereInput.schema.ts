...
type SchemaType = z.ZodType<Prisma.HealthPlansScalarWhereInput>;
export const HealthPlansScalarWhereInputObjectSchema: SchemaType = z.object({
    AND: z.union([z.lazy(() => HealthPlansScalarWhereInputObjectSchema),
    z.lazy(() => HealthPlansScalarWhereInputObjectSchema).array()]).optional(), OR: z.lazy(() => HealthPlansScalarWhereInputObjectSchema).array().optional().optional(), NOT: z.union([z.lazy(() => HealthPlansScalarWhereInputObjectSchema),
    z.lazy(() => HealthPlansScalarWhereInputObjectSchema).array()]).optional(), id: z.union([z.lazy(() => StringFilterObjectSchema),
