...
type SchemaType = z.ZodType<Prisma.HealthPlansUncheckedCreateWithoutOrganizationInput>;
export const HealthPlansUncheckedCreateWithoutOrganizationInputObjectSchema: SchemaType = z.object({
    ...
    z.null()]).optional().nullable(), deleted: z.boolean().optional().optional(), patientId: z.string(), healthPlansValuesId: z.string()
