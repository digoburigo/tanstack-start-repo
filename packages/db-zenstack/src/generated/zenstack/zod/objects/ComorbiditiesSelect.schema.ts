...
type SchemaType = z.ZodType<Prisma.ComorbiditiesSelect>;
export const ComorbiditiesSelectObjectSchema: SchemaType = z.object({
    ...
    z.lazy(() => PatientDefaultArgsObjectSchema)]).optional(), comorbiditiesValuesId: z.boolean().optional().optional(), comorbiditiesValues: z.union([z.boolean(),
    z.lazy(() => ComorbiditiesValuesDefaultArgsObjectSchema)]).optional(), appointmentId: z.boolean().optional().optional(), appointment: z.union([z.boolean(),
