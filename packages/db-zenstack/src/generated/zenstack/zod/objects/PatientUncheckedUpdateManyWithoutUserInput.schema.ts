...
type SchemaType = z.ZodType<Prisma.PatientUncheckedUpdateManyWithoutUserInput>;
export const PatientUncheckedUpdateManyWithoutUserInputObjectSchema: SchemaType = z.object({
    id: z.union([z.string(),
