...
type SchemaType = z.ZodType<Prisma.AppointmentCidScalarWhereWithAggregatesInput>;
export const AppointmentCidScalarWhereWithAggregatesInputObjectSchema: SchemaType = z.object({
    AND: z.union([z.lazy(() => AppointmentCidScalarWhereWithAggregatesInputObjectSchema),
    z.lazy(() => AppointmentCidScalarWhereWithAggregatesInputObjectSchema).array()]).optional(), OR: z.lazy(() => AppointmentCidScalarWhereWithAggregatesInputObjectSchema).array().optional().optional(), NOT: z.union([z.lazy(() => AppointmentCidScalarWhereWithAggregatesInputObjectSchema),
    z.lazy(() => AppointmentCidScalarWhereWithAggregatesInputObjectSchema).array()]).optional(), id: z.union([z.lazy(() => StringWithAggregatesFilterObjectSchema),
    ...
    z.string(),
    z.null()]).optional().nullable(), appointmentId: z.union([z.lazy(() => StringWithAggregatesFilterObjectSchema),
    z.string()]).optional(), cidId: z.union([z.lazy(() => StringWithAggregatesFilterObjectSchema),
    z.string()]).optional()
