...
type SchemaType = z.ZodType<Prisma.UserUncheckedCreateWithoutMembersInput>;
export const UserUncheckedCreateWithoutMembersInputObjectSchema: SchemaType = z.object({
    ...
    z.null()]).optional().nullable(), sessions: z.lazy(() => SessionUncheckedCreateNestedManyWithoutUserInputObjectSchema).optional().optional(), accounts: z.lazy(() => AccountUncheckedCreateNestedManyWithoutUserInputObjectSchema).optional().optional(), invitations: z.lazy(() => InvitationUncheckedCreateNestedManyWithoutUserInputObjectSchema).optional().optional(), patientUser: z.lazy(() => PatientUncheckedCreateNestedManyWithoutUserInputObjectSchema).optional().optional(), createdAssets: z.lazy(() => AssetUncheckedCreateNestedManyWithoutCreatedByUserInputObjectSchema).optional().optional(), updatedAssets: z.lazy(() => AssetUncheckedCreateNestedManyWithoutUpdatedByUserInputObjectSchema).optional().optional(), deletedAssets: z.lazy(() => AssetUncheckedCreateNestedManyWithoutDeletedByUserInputObjectSchema).optional().optional()
