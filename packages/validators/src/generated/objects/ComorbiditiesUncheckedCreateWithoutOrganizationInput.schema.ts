...
type SchemaType = z.ZodType<Prisma.ComorbiditiesUncheckedCreateWithoutOrganizationInput>;
export const ComorbiditiesUncheckedCreateWithoutOrganizationInputObjectSchema: SchemaType = z.object({
    ...
    z.null()]).optional().nullable(), deleted: z.boolean().optional().optional(), patientId: z.union([z.string(),
