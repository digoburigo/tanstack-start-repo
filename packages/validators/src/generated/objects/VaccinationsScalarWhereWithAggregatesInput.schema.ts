...
type SchemaType = z.ZodType<Prisma.VaccinationsScalarWhereWithAggregatesInput>;
export const VaccinationsScalarWhereWithAggregatesInputObjectSchema: SchemaType = z.object({
    AND: z.union([z.lazy(() => VaccinationsScalarWhereWithAggregatesInputObjectSchema),
    z.lazy(() => VaccinationsScalarWhereWithAggregatesInputObjectSchema).array()]).optional(), OR: z.lazy(() => VaccinationsScalarWhereWithAggregatesInputObjectSchema).array().optional().optional(), NOT: z.union([z.lazy(() => VaccinationsScalarWhereWithAggregatesInputObjectSchema),
    z.lazy(() => VaccinationsScalarWhereWithAggregatesInputObjectSchema).array()]).optional(), id: z.union([z.lazy(() => StringWithAggregatesFilterObjectSchema),
    ...
    z.string()]).optional(), vaccinationsValuesId: z.union([z.lazy(() => StringWithAggregatesFilterObjectSchema),
    z.string()]).optional()
