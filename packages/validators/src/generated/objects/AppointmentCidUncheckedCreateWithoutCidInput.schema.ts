...
type SchemaType = z.ZodType<Prisma.AppointmentCidUncheckedCreateWithoutCidInput>;
export const AppointmentCidUncheckedCreateWithoutCidInputObjectSchema: SchemaType = z.object({
    ...
    z.null()]).optional().nullable(), appointmentId: z.string()
