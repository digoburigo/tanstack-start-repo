...
type SchemaType = z.ZodType<Prisma.AppointmentWhereUniqueInput>;
export const AppointmentWhereUniqueInputObjectSchema: SchemaType = z.object({
    id: z.string().optional().optional(), followUpId: z.string().optional().optional(), AND: z.union([z.lazy(() => AppointmentWhereInputObjectSchema),
    ...
    z.lazy(() => AppointmentWhereInputObjectSchema).array()]).optional(), type: z.union([z.lazy(() => StringFilterObjectSchema),
