...
type SchemaType = z.ZodType<Prisma.DefaultObjectiveInformationSelect>;
export const DefaultObjectiveInformationSelectObjectSchema: SchemaType = z.object({
    ...
    z.lazy(() => OrganizationDefaultArgsObjectSchema)]).optional(), text: z.boolean().optional().optional()
