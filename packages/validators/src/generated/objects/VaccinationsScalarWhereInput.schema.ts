...
type SchemaType = z.ZodType<Prisma.VaccinationsScalarWhereInput>;
export const VaccinationsScalarWhereInputObjectSchema: SchemaType = z.object({
    AND: z.union([z.lazy(() => VaccinationsScalarWhereInputObjectSchema),
    z.lazy(() => VaccinationsScalarWhereInputObjectSchema).array()]).optional(), OR: z.lazy(() => VaccinationsScalarWhereInputObjectSchema).array().optional().optional(), NOT: z.union([z.lazy(() => VaccinationsScalarWhereInputObjectSchema),
    z.lazy(() => VaccinationsScalarWhereInputObjectSchema).array()]).optional(), id: z.union([z.lazy(() => StringFilterObjectSchema),
