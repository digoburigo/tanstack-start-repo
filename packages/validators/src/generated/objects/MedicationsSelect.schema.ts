...
type SchemaType = z.ZodType<Prisma.MedicationsSelect>;
export const MedicationsSelectObjectSchema: SchemaType = z.object({
    ...
    z.lazy(() => PatientDefaultArgsObjectSchema)]).optional(), medicationsValuesId: z.boolean().optional().optional(), medicationsValues: z.union([z.boolean(),
    z.lazy(() => MedicationsValuesDefaultArgsObjectSchema)]).optional(), appointmentId: z.boolean().optional().optional(), appointment: z.union([z.boolean(),
