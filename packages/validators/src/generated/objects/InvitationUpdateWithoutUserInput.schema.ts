...
type SchemaType = z.ZodType<Prisma.InvitationUpdateWithoutUserInput>;
export const InvitationUpdateWithoutUserInputObjectSchema: SchemaType = z.object({
    id: z.union([z.string(),
    ...
    z.null()]).optional().nullable(), organization: z.lazy(() => OrganizationUpdateOneRequiredWithoutInvitationsNestedInputObjectSchema).optional().optional()
