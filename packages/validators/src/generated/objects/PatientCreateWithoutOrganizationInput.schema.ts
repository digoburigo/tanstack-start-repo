...
type SchemaType = z.ZodType<Prisma.PatientCreateWithoutOrganizationInput>;
export const PatientCreateWithoutOrganizationInputObjectSchema: SchemaType = z.object({
    ...
    z.null()]).optional().nullable(), createdByUser: z.lazy(() => UserCreateWithoutCreatedAssetsInputObjectSchema).optional().optional(), updatedByUser: z.lazy(() => UserCreateWithoutUpdatedAssetsInputObjectSchema).optional().optional(), deletedByUser: z.lazy(() => UserCreateWithoutDeletedAssetsInputObjectSchema).optional().optional(), user: z.lazy(() => UserCreateNestedOneWithoutPatientUserInputObjectSchema).optional().optional(), appointments: z.lazy(() => AppointmentCreateNestedManyWithoutPatientInputObjectSchema).optional().optional(), vaccinations: z.lazy(() => VaccinationsCreateNestedManyWithoutPatientInputObjectSchema).optional().optional(), allergies: z.lazy(() => AllergiesCreateNestedManyWithoutPatientInputObjectSchema).optional().optional(), medications: z.lazy(() => MedicationsCreateNestedManyWithoutPatientInputObjectSchema).optional().optional(), examResults: z.lazy(() => ExamResultsCreateNestedManyWithoutPatientInputObjectSchema).optional().optional(), comorbidities: z.lazy(() => ComorbiditiesCreateNestedManyWithoutPatientInputObjectSchema).optional().optional(), surgeries: z.lazy(() => SurgeriesCreateNestedManyWithoutPatientInputObjectSchema).optional().optional(), healthPlans: z.lazy(() => HealthPlansCreateNestedManyWithoutPatientInputObjectSchema).optional().optional()
