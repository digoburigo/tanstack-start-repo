...
type SchemaType = z.ZodType<Prisma.VaccinationsUncheckedCreateWithoutPatientInput>;
export const VaccinationsUncheckedCreateWithoutPatientInputObjectSchema: SchemaType = z.object({
    ...
    z.null()]).optional().nullable(), vaccinationsValuesId: z.string()
