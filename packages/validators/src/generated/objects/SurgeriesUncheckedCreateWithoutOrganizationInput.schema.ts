...
type SchemaType = z.ZodType<Prisma.SurgeriesUncheckedCreateWithoutOrganizationInput>;
export const SurgeriesUncheckedCreateWithoutOrganizationInputObjectSchema: SchemaType = z.object({
    ...
    z.null()]).optional().nullable(), deleted: z.boolean().optional().optional(), patientId: z.string(), surgeriesValuesId: z.string()
