...
type SchemaType = z.ZodType<Prisma.ComorbiditiesCreateWithoutOrganizationInput>;
export const ComorbiditiesCreateWithoutOrganizationInputObjectSchema: SchemaType = z.object({
    ...
    z.null()]).optional().nullable(), deleted: z.boolean().optional().optional(), createdByUser: z.lazy(() => UserCreateWithoutCreatedAssetsInputObjectSchema).optional().optional(), updatedByUser: z.lazy(() => UserCreateWithoutUpdatedAssetsInputObjectSchema).optional().optional(), deletedByUser: z.lazy(() => UserCreateWithoutDeletedAssetsInputObjectSchema).optional().optional(), patient: z.lazy(() => PatientCreateNestedOneWithoutComorbiditiesInputObjectSchema).optional().optional(), comorbiditiesValues: z.lazy(() => ComorbiditiesValuesCreateNestedOneWithoutComorbiditiesInputObjectSchema), appointment: z.lazy(() => AppointmentCreateNestedOneWithoutComorbiditiesInputObjectSchema).optional().optional()
