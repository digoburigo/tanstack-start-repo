...
type SchemaType = z.ZodType<Prisma.DefaultObjectiveInformationCreateWithoutUpdatedByUserInput>;
export const DefaultObjectiveInformationCreateWithoutUpdatedByUserInputObjectSchema: SchemaType = z.object({
    ...
    z.null()]).optional().nullable(), createdByUser: z.lazy(() => UserCreateWithoutCreatedAssetsInputObjectSchema).optional().optional(), deletedByUser: z.lazy(() => UserCreateWithoutDeletedAssetsInputObjectSchema).optional().optional(), organization: z.lazy(() => OrganizationCreateWithoutAssetsInputObjectSchema).optional().optional()
