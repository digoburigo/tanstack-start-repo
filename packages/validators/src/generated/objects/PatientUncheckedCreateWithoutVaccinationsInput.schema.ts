...
import { HealthPlansUncheckedCreateNestedManyWithoutPatientInputObjectSchema } from './HealthPlansUncheckedCreateNestedManyWithoutPatientInput.schema';

import type { Prisma } from '../../../../db-zenstack/src/generated/zenstack/models';

type SchemaType = z.ZodType<Prisma.PatientUncheckedCreateWithoutVaccinationsInput>;
export const PatientUncheckedCreateWithoutVaccinationsInputObjectSchema: SchemaType = z.object({
    ...
    z.null()]).optional().nullable(), appointments: z.lazy(() => AppointmentUncheckedCreateNestedManyWithoutPatientInputObjectSchema).optional().optional(), allergies: z.lazy(() => AllergiesUncheckedCreateNestedManyWithoutPatientInputObjectSchema).optional().optional(), medications: z.lazy(() => MedicationsUncheckedCreateNestedManyWithoutPatientInputObjectSchema).optional().optional(), examResults: z.lazy(() => ExamResultsUncheckedCreateNestedManyWithoutPatientInputObjectSchema).optional().optional(), comorbidities: z.lazy(() => ComorbiditiesUncheckedCreateNestedManyWithoutPatientInputObjectSchema).optional().optional(), surgeries: z.lazy(() => SurgeriesUncheckedCreateNestedManyWithoutPatientInputObjectSchema).optional().optional(), healthPlans: z.lazy(() => HealthPlansUncheckedCreateNestedManyWithoutPatientInputObjectSchema).optional().optional()
