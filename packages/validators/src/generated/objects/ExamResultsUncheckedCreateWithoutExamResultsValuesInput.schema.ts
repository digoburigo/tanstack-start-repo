...
type SchemaType = z.ZodType<Prisma.ExamResultsUncheckedCreateWithoutExamResultsValuesInput>;
export const ExamResultsUncheckedCreateWithoutExamResultsValuesInputObjectSchema: SchemaType = z.object({
    ...
    z.null()]).optional().nullable(), patientId: z.string(), result: z.string(), date: z.union([z.date(), z.string().datetime()])
