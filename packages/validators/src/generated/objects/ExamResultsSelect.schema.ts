...
type SchemaType = z.ZodType<Prisma.ExamResultsSelect>;
export const ExamResultsSelectObjectSchema: SchemaType = z.object({
    ...
    z.lazy(() => PatientDefaultArgsObjectSchema)]).optional(), examResultsValuesId: z.boolean().optional().optional(), examResultsValues: z.union([z.boolean(),
    z.lazy(() => ExamResultsValuesDefaultArgsObjectSchema)]).optional(), result: z.boolean().optional().optional(), date: z.boolean().optional().optional()
