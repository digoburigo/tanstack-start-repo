...
type SchemaType = z.ZodType<Prisma.SurgeriesUncheckedCreateWithoutPatientInput>;
export const SurgeriesUncheckedCreateWithoutPatientInputObjectSchema: SchemaType = z.object({
    ...
    z.null()]).optional().nullable(), surgeriesValuesId: z.string()
