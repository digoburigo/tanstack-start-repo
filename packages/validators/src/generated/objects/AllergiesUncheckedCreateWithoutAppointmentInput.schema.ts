...
type SchemaType = z.ZodType<Prisma.AllergiesUncheckedCreateWithoutAppointmentInput>;
export const AllergiesUncheckedCreateWithoutAppointmentInputObjectSchema: SchemaType = z.object({
    ...
    z.null()]).optional().nullable(), allergiesValuesId: z.string()
