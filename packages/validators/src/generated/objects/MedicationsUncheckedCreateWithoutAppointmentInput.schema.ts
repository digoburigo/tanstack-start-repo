...
type SchemaType = z.ZodType<Prisma.MedicationsUncheckedCreateWithoutAppointmentInput>;
export const MedicationsUncheckedCreateWithoutAppointmentInputObjectSchema: SchemaType = z.object({
    ...
    z.null()]).optional().nullable(), medicationsValuesId: z.string()
