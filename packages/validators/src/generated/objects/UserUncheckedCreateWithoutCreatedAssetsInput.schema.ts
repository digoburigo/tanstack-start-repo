...
type SchemaType = z.ZodType<Prisma.UserUncheckedCreateWithoutCreatedAssetsInput>;
export const UserUncheckedCreateWithoutCreatedAssetsInputObjectSchema: SchemaType = z.object({
    ...
    z.null()]).optional().nullable(), sessions: z.lazy(() => SessionUncheckedCreateNestedManyWithoutUserInputObjectSchema).optional().optional(), accounts: z.lazy(() => AccountUncheckedCreateNestedManyWithoutUserInputObjectSchema).optional().optional(), members: z.lazy(() => MemberUncheckedCreateNestedManyWithoutUserInputObjectSchema).optional().optional(), invitations: z.lazy(() => InvitationUncheckedCreateNestedManyWithoutUserInputObjectSchema).optional().optional(), patientUser: z.lazy(() => PatientUncheckedCreateNestedManyWithoutUserInputObjectSchema).optional().optional(), updatedAssets: z.lazy(() => AssetUncheckedCreateNestedManyWithoutUpdatedByUserInputObjectSchema).optional().optional(), deletedAssets: z.lazy(() => AssetUncheckedCreateNestedManyWithoutDeletedByUserInputObjectSchema).optional().optional()
