...
type SchemaType = z.ZodType<Prisma.PatientUncheckedUpdateManyWithoutUpdatedByUserInput>;
export const PatientUncheckedUpdateManyWithoutUpdatedByUserInputObjectSchema: SchemaType = z.object({
    id: z.union([z.string(),
