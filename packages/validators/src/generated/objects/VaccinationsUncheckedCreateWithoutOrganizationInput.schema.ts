...
type SchemaType = z.ZodType<Prisma.VaccinationsUncheckedCreateWithoutOrganizationInput>;
export const VaccinationsUncheckedCreateWithoutOrganizationInputObjectSchema: SchemaType = z.object({
    ...
    z.null()]).optional().nullable(), deleted: z.boolean().optional().optional(), patientId: z.string(), vaccinationsValuesId: z.string()
